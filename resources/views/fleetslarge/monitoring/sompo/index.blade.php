        ...
        <div class="col-sm-11">
            <div class="row div-device-status">
                <div class="col-sm-1 col-3">
                    <i class="fa fa-truck-moving"></i> <label for="">Placa</label><br />
                    <b for="" id="placa">---</b>
                </div>
                ...
                <div class="col-sm-1 col-6">
                    <i class="fa fa-truck-moving"></i> <label for="">Velocidade</label><br />
                    <b for="" id="lp_velocidade">---</b>
                </div>


                <div class="col-sm-2 col-6">
                    <i class="fa fa-truck-moving"></i> <label for="">Chassis</label><br />
                    <b for="" id="chassis">---</b>
                </div>

                <div class="col-sm-3 col-6">
                    <i class="fa fa-truck" id="icon-nivel-bateria"></i> <label for=""> Modelo</label><br />
                    <b for="" id="modelo_veiculo">---</b>
                </div>

                <div class="col-sm-1 col-6">
                    <i class="fa  fa-truck-movingt"></i> <label for="">Categoria</label><br />
