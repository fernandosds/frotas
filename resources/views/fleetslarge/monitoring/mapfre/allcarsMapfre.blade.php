                ...
                pointToLayer: function(feature, latlng) {
                    ...
                    return L.marker(latlng, {
                        ...
                        .bindPopup('<strong>' + feature.properties.placa + '</strong>' +
                            ...
                            '<br /><strong><br>Categoria do Veículo:</strong>  ' + (feature.properties.categoria_veiculo ?? '') + ' ' +
                            '<br /><strong><br>Data de instalação:</strong>  ' + (feature.properties.data_instalacao ? feature.properties.data_instalacao.replace(/(\d*)-(\d*)-(\d*)T(\d*):(\d*):(\d*)-(\d*):(\d*).*/, '$3/$2/$1 $4:$5:$6') : '') + ' ' +
                            '<br /><strong><br>Última Trasmissão:</strong>  ' + (feature.properties.lp_ultima_transmissao ? feature.properties.lp_ultima_transmissao.replace(/(\d*)-(\d*)-(\d*)T(\d*):(\d*):(\d*)-(\d*):(\d*).*/, '$3/$2/$1 $4:$5:$6') : '') + ' '
                        );
