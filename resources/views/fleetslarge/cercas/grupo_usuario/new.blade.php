        ...
        <div class="kt-portlet__body">
            <div class="form-group row">
                <div class="col-lg-4">
                    ...
                    <input type="text" class="form-control" id="name" value="{{isset($grupo) ? $grupo->name : null}}">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-lg-4" style="margin-top: 9px;">
                    <div class="kt-input-icon kt-input-icon--right">
                        ...
                        <select multiple size="10" class="form-control col-md-10 rightBox seguradoresRight" id="seguradoresLeft" name='seguradoras[]'>
                            @if(isset($grupo))
                                @foreach($grupo->grupoUsuarioRelacionamento as $grupoRelacionamento)
                                    <option value="">{{$grupoRelacionamento->nome_usuario}}</option>
                                @endforeach
                            @endif
                        </select>
                    </div>
...
<script>
    ...
    $('#btn-user-save').click(function() {
        ...
        ajax_store(id_grupo, "fleetslarges/cercas/save", data);
    });
</script>
