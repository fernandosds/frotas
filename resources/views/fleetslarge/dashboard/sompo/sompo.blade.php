                    ...
                    <table id="example" class="display" style="width:50%">
                        ...
                        <tbody id="tbodyVehicle">
                            ...
                            <tr id='_tr_car_{{$driver["chassis"]}}'>
                                ...
                                <td>
                                    <button type="button" class="btn btn-success  btn-elevate btn-circle btn-icon btn-vehicle-sompo-data" data-toggle="modal" data-target="#modalSompo" data-chassi="{{$driver['chassis']}}">
...
@include('fleetslarge.dashboard.sompo.modalSompo')
...
<script>
    $(document).ready(function() {
        ...
        $('#example').DataTable({
            ...
            buttons: [{
                    extend: 'pdf',
                    title: 'SAT Company :: Grid Sompo_' + date,
                    exportOptions: {
                        columns: columsPdf
                    },
    ...
    /* Details vehicle Sompo */
    $('.btn-vehicle-sompo-data').click(function() {
