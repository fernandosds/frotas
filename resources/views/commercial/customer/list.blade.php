                    ...
                    <tr id="_tr_user_{{$customer->id}}">
                        ...
                        <td>
                            <div class="pull-right">
                                <a href="{{url('commercial/contracts/new')}}/{{$customer->id}}"
                                    class="btn btn-sm btn-warning"><span class="fa fa-fw fa-file"></span> Novo
                                    Contrato</a>
                                <a href="{{url('commercial/customers/edit')}}/{{$customer->id}}"
